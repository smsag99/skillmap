    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 32, textAlign: 'center' }}>
          ...
          <h1 style={{ color: '#e8e6e0', fontSize: 22, fontWeight: 500, margin: 0 }}>Welcome back</h1>
          <p style={{ color: '#555565', fontSize: 14, marginTop: 6 }}>Sign in to your SkillMap account</p>
        </div>
